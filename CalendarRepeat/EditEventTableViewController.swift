...
class EditEventTableViewController: UITableViewController {
    ...
    @IBAction func unwindToEditEvent(segue: UIStoryboardSegue) {
        if let sourceViewController = segue.source as? SelectFrequencyTableViewController {
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let controller = segue.destination as? SelectFrequencyTableViewController
        controller?.selectedFrequency = repeatFrequencyLabel.text
    }
